...
CREATE INDEX idx_tags1 ON tags (tag);
...
CREATE INDEX idx_tags_filters1 ON tags_filters (tag_id);
...
CREATE INDEX idx_whitelist_rules2 ON whitelist_rules (path(20));
CREATE INDEX idx_whitelist_rules3 ON whitelist_rules (caller(20));
CREATE INDEX idx_whitelist_rules4 ON whitelist_rules (min_length);
CREATE INDEX idx_whitelist_rules5 ON whitelist_rules (max_length);
CREATE INDEX idx_whitelist_rules6 ON whitelist_rules (filter_id);
CREATE INDEX idx_whitelist_rules7 ON whitelist_rules (date);
CREATE INDEX idx_whitelist_rules8 ON whitelist_rules (status);
